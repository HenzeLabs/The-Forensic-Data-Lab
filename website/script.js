...
function displayAuditResults(results, container) {
    const scoreColor = results.score >= 80 ? 'success' : results.score >= 60 ? 'warning' : 'error';
...
function calculateLoss() {
    ...
    const optimizationLoss = monthlyRevenue * 0.20; // 20% optimization loss
...
function initializeAnimations() {
    ...
    const animatedElements = document.querySelectorAll('.problem-item, .process-step, .pricing-card');
