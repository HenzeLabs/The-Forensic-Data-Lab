...
#GA4 #MarketingAnalytics #DataDriven #MarketingROI`,
                            hashtags: ["#GA4", "#MarketingAnalytics", "#DataDriven", "#MarketingROI", "#ConversionTracking"],
                            cta: "What's your tracking health score? Find out in 5 minutes: [link]"
                        },
                        {
                            type: "carousel_post", 
                            theme: "educational",
                            content: "5 Signs Your GA4 Tracking Is Broken (And Costing You Money)",
                            slides: [
                                {
                                    title: "Sign #1: Your conversion numbers don't add up",
                                    description: "GA4 shows 100 purchases, but Shopify shows 150. Sound familiar?"
                                },
                                {
                                    title: "Sign #2: Facebook says 'No conversions'",
                                    description: "Your ads are working, but Facebook can't see the conversions"
                                },
                                {
                                    title: "Sign #3: Your best traffic source is 'Direct'",
                                    description: "If most traffic shows as 'direct', attribution is broken"
                                },
                                {
                                    title: "Sign #4: E-commerce events are at 0%",
                                    description: "No view_item, add_to_cart, or purchase events firing"
                                },
                                {
                                    title: "Sign #5: Cross-domain tracking issues",
                                    description: "Sessions break when users go from site to checkout"
                                }
                            ],
...
#GA4Migration #WebTracking #MarketingAnalytics`,
                    ...
                    ads: [
                        {
                            ...
                            description: "80% of businesses have broken tracking. Find out what's wrong with yours in 5 minutes.",
                            image_concept: "Split screen: broken tracking dashboard vs fixed dashboard",
                    ...
                    ads: [
                        {
                            ...
                            description: "Don't let broken tracking cost you another month of revenue.",
                            cards: [
                                {
            ...
            content: {
                posts: [
                    ...
                    },
                    {
                        type: "reel",
                        theme: "educational",
                        content: "POV: You just realized your tracking has been broken for months 😅\n\n✅ Save this post\n✅ Tag a friend who needs to see this  \n✅ Get your free audit (link in bio)\n\n#MarketingTips #GA4 #TrackingProblems #SmallBusiness",
                        video_concept: "Trending audio with text overlay showing tracking problems"
                    }
                ],
                ...
                stories: [
                    ...
                    },
                    {
                        ...
                        follow_up: "DM me your question + website and I'll audit it for free!"
                    }
                ]
            }
        };
                ...
                videos: [
                    {
                        ...
                        hashtags: ["#FacebookAds", "#MarketingTips", "#SmallBusiness", "#TrackingProblems"]
                    },
                    {
    ...
    createYouTubeCampaigns() {
        return {
            platform: "YouTube", 
            audience: "Marketing professionals, business owners seeking in-depth content",
            
            content: {
                long_form: [
                    {
                        title: "Why 80% of GA4 Setups Are Broken (And How to Fix Yours)",
                        description: "Complete guide to auditing and fixing your GA4 tracking setup",
    ...
    getCampaignContent(platform, campaignType, postType = null) {
        ...
        if (postType) {
            return platformData.campaigns[campaignType].posts.filter(post => 
                post.type === postType
            );
        }
